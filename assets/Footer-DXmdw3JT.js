import{r as a,j as e,H as i,L as l}from"./index-B59bCOI3.js";function d(){const n=a.useRef(null),o=()=>{n.current&&!n.current.open&&(n.current.showModal(),n.current.focus())},t=()=>{n.current&&n.current.open&&n.current.close()},r=s=>{s.target===s.currentTarget&&n.current?.close()};return e.jsxs("footer",{className:`
            group 
            px-4 
            pb-15 
            flex 
            ...
            gap-6`,children:[e.jsx("div",{className:"shrink-0",children:e.jsx(i,{})}),e.jsx("p",{className:"mx-auto text-center",children:"© 2026 Mon Portfolio. Tous droits réservés. Code source disponible sous licence ISC sur GitHub."}),e.jsxs("div",{className:`
                ...
                group`,children:[e.jsx("button",{id:"legal",type:"button",onClick:o,className:`
                    ...
                    duration-600 
                    ease-in-out 
                    hover:text-blue-600`,children:"mentions légales"}),e.jsx(l,{})]}),e.jsxs("dialog",{ref:n,"aria-labelledby":"legal-title","aria-modal":"true",onClick:r,className:`
                p-10 
                max-w-[80vw] 
                m-auto
                max-h-[80vh] 
                ...
                backdrop:backdrop-blur-sm`,children:[e.jsxs("div",{className:`
                    ...
                    max-h-[calc(80vh-5rem)]`,children:[e.jsx("div",{className:`
                        text-sm 
                        text-gray-500 
                        mb-4`,children:"Faites défiler pour tout lire s'il vous plaît"}),e.jsx("h2",{className:`
                        pt-8 
                        text-2xl
