          ...
          motion-safe:ease-in-out`,children:e.jsx("div",{className:`
            ...
            shadow-xs`,children:[e.jsxs("div",{className:`
                    ...
                    text-center`,children:[e.jsxs("span",{className:`
                        ...
                        font-semibold 
                        tracking-tight 
                        text-heading`,children:n.title}),e.jsx(g,{paths:i,repo:n.repository})]}),e.jsx("div",{className:"space-y-4",children:e.jsxs(j,{summary:"Découvrez ce projet",children:[e.jsx("h6",{className:"font-extrabold mt-2",children:"contexte"}),e.jsx("p",{children:n.contexte}),e.jsx("h6",{className:"font-extrabold mt-2",children:"objectifs"}),e.jsx("p",{children:n.objectifs}),e.jsx("h6",{className:"font-extrabold mt-2",children:"stack technique"}),e.jsx("p",{children:n.stackTechnique}),e.jsx("h6",{className:"font-extrabold mt-2",children:"compétences développées"}),e.jsx("p",{children:n.competencesDeveloppees}),e.jsx("h6",{className:"font-extrabold mt-2",children:"résultats et impact"}),e.jsx("p",{children:n.resultatsEtImpact}),e.jsx("h6",{className:"font-extrabold mt-2",children:"perspectives d'amélioration"}),e.jsx("p",{children:n.perspectivesAmelioration})]})})]})}function y({projectsPath:n}){const[a,s]=c.useState([]),[t,i]=c.useState(!0),[o]=c.useState(null),d=c.useRef(null);return c.useEffect(()=>{let l=!0;return(async()=>{try{const r=await fetch("./data/projects.json");if(!r.ok)throw new Error(`HTTP error: ${r.status}`);const f=await r.json();l&&(s(f),i(!1))}catch(r){l&&(r instanceof SyntaxError||r instanceof ReferenceError||r instanceof TypeError||r instanceof Error)&&console.log("error: "+r.message)}})(),()=>{l=!1}},[]),t?e.jsx("p",{children:"chargement des projets"}):o?e.jsxs("p",{children:["erreur: ",o]}):e.jsx("div",{ref:d,className:`
                flex
                flex-col
                justify-center
                items-center 
